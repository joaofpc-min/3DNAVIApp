...
package androidx.compose.samples.threednavi.details

import androidx.compose.samples.threednavi.R
import androidx.compose.samples.threednavi.data.DestinationsRepository
import androidx.compose.samples.threednavi.data.ExploreModel
import androidx.compose.samples.threednavi.data.MADRID
